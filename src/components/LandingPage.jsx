...
export default function LandingPage() {
  ...
  return (
    <div className='px-10 py-2'>
        ...
        <div>
          <button className='bg-blue-400 rounded-lg p-2 my-3 flex gap-2' onClick={addStudent}>
                ...
                student =>
                  <tr key={student.student_id}>
                    ...
                    <td className='border justify-center'>
                      <div className='w-full flex justify-center' onClick={() => removeStudent(student.student_id)}>
